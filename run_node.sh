...
i=0
f="layer${i}.blif"
./build/ttopt_node ${dirname}/blif/${f} ${dirname}/blifopt/${f} ${dirname}/train${i}.sim $nout $rarity
...
i=$(($nfile - 1))
f="layer${i}.blif"
./build/ttopt_node ${dirname}/blif/${f} ${dirname}/blifopt/${f} ${dirname}/train${i}.sim $noutl $rarity
